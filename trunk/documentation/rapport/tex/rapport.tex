...
La figure \refp{fig:ImplicationTailleBuffersSurReemissions01} illustre le résultat de la simulation. On voit qu'avec cette taille de buffers, il n'y a quasiment aucune réémissions même après un long temps de simulation. La figure \refp{fig:ImplicationTailleBuffersSurReemissions02} montre quant à elle que quand les buffers sont trop petits ($3$ au lieu de $10$ (donc qu'il y a des pertes de messages à cause de buffers pleins), le nombre de réémissions augmente.


\begin{figure}[h!t]
  \centering
    \includegraphics[scale=0.55]{ImplicationTailleBuffersSurReemissions01}
...
\begin{figure}[h!t]
  \centering
    \includegraphics[scale=0.55]{ImplicationTailleBuffersSurReemissions02}
...
\begin{figure}[h!t]
  \centering
    \includegraphics[scale=0.55]{ImplicationTailleBuffersSurTempsVoyage02}
